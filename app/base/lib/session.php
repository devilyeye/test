...
class base_session{
    ...
    public function is_back_sess_key(){
        $sess_type = 'back_s';
        if(defined('BACK_SESS_NAME') && constant('BACK_SESS_NAME'))    $sess_type = 'back_'.constant('BACK_SESS_NAME');
        $this->_sess_key=$sess_type;
        $this->_is_back = true;
    }
